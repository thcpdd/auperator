...
if TYPE_CHECKING:
    ...
    from auperator.deepagents.backends.protocol import BACKEND_TYPES, BackendProtocol
...
from auperator.deepagents.middleware._utils import append_to_system_message
